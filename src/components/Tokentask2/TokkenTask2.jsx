  ...
  return (
    <div className="z-0 flex flex-col items-center w-full min-h-screen pb-16 lg:pb-0 ">
        ...
        <div className="mx-auto px-4 max-w-7xl sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
                      ...
                      >
                        ...
                        >
                          <img
                            alt=""
                            aria-hidden="true"
                            src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNjI4IiBoZWlnaHQ9IjYyOCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4="
                            style={{
                              maxWidth: "100%",
                              display: "block",
                              margin: "0px",
                        ...
                        <img
                          alt="Create My Token Logo"
                          src="/_next/image?url=%2F_next%2Fstatic%2Fimage%2Fpublic%2Fimages%2FLogo.98ceec9800d76ee5c6aab76ef60d721f.png&w=1920&q=75"
                          decoding="async"
                          data-nimg="intrinsic"
                          className="block  "
                          srcSet="/_next/image?url=%2F_next%2Fstatic%2Fimage%2Fpublic%2Fimages%2FLogo.98ceec9800d76ee5c6aab76ef60d721f.png&w=640&q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fimage%2Fpublic%2Fimages%2FLogo.98ceec9800d76ee5c6aab76ef60d721f.png&w=1920&q=75 2x"
                          style={{
                            position: "absolute",
                            inset: "0px",
                            boxSizing: "border-box",
                      ...
                      >
                        ...
                        >
                          ...
                          <img
                            alt="en"
                            aria-hidden="true"
                            src="/_next/image?url=%2Fimages%2Fflags%2Fen-flag.png&w=48&q=75"
                            decoding="async"
                            data-nimg="intrinsic"
                            className="inline w-3 h-3 mr-1 align-middle"
                            srcSet="/_next/image?url=%2Fimages%2Fflags%2Fen-flag.png&w=32&q=75 1x, /_next/image?url=%2Fimages%2Fflags%2Fen-flag.png&w=48&q=75 2x"
                            style={{
                              position: "absolute",
                              inset: "0px",
                              boxSizing: "border-box",
            ...
            <div className="flex items-center -mr-2 sm:hidden">
              <button className="inline-flex items-center justify-center p-2 text-gray-400 hover:text-gray-500 focus:text-gray-500 hover:bg-gray-100 focus:bg-gray-100 rounded-md focus:outline-none transition duration-150 ease-in-out">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth={0}
                  ...
                  <div className="grid gap-4 grid-cols-2">
                    <div className="col-span-2">
                      <div>
                        ...
                        />
                        <p className="mt-1 text-gray-500 text-sm">
                          Starting number of supply of your token, will be
      ...
      <div className="bg-black w-full pt-10 text-white text-center p-3">
        Copyright © Token Generator 2022
      </div>
    </div>
  );
};
